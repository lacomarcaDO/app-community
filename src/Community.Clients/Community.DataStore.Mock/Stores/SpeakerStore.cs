            ...
            for (var i = 0; i < 50; i++)
            {
               ...
               var company = Companies[random.Next(0, Companies.Length - 1)];
                ...
                yield return new Speaker
                {
                    ...
                    LastName = lastName,
                    PositionName = title,
                    Biography = $"Hi my name is {firstName}, I love you! This is my super awesome bio that you should read at the Community and it is awesome and pretty long. I thank you for coming to my sessions!",
