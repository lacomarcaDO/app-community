            ...
            Events.Add(new FeaturedEvent
                {
                    ...
                    Description = "Get ready for Community training with open registration and full system configuration prep throughout the day!",
